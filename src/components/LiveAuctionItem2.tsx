...
const LiveAuctionItem2 = ({ doc }: { doc: any }) => {
	...
	return (
		<Link href={`/assets/${doc.id}`}>
			<div className=" w-[100%] md:w-[200px]">
				...
				<p className="text-sm font-semibold flex-1 mt-2">{doc.title}</p>
				...
				<div className="flex justify-between items-center border-b border-gray-500">
					...
					<div className="px-2 py-2 bg-[#514CFF26] h-7 rounded ml-3">
...
export default LiveAuctionItem2;
